...
// File generated on 27/05/2015 9:22:06 AM from Type Library described below.
...
// *********************************************************************//
  IShapefile = interface(IDispatch)
    ...
    function  StopEditingShapes(ApplyChanges: WordBool; StopEditTable: WordBool; 
                                const cBack: ICallback): WordBool; safecall;
    function  EditInsertField(const NewField: IField; var FieldIndex: Integer; 
                              const cBack: ICallback): WordBool; safecall;
...
// *********************************************************************//
  IShapefileDisp = dispinterface
    ...
    function  EditInsertField(const NewField: IField; var FieldIndex: Integer; 
                              const cBack: ICallback): WordBool; dispid 22;
...
// *********************************************************************//
  TMapMouseDown = procedure(Sender: TObject; Button: Smallint; Shift: Smallint; x: Integer; 
                                             y: Integer) of object;
  TMapMouseUp = procedure(Sender: TObject; Button: Smallint; Shift: Smallint; x: Integer; y: Integer) of object;
  TMapMouseMove = procedure(Sender: TObject; Button: Smallint; Shift: Smallint; x: Integer; 
                                             y: Integer) of object;
  TMapFileDropped = procedure(Sender: TObject; const Filename: WideString) of object;
  TMapSelectBoxFinal = procedure(Sender: TObject; Left: Integer; Right: Integer; Bottom: Integer; 
